...
games.count()
all_games = games.drop(['id', 'white_id', 'black_id', 'moves','created_at','last_move_at'], axis=1)
cleaned_games = all_games[all_games['winner'] != 'draw'].head(1000)
print(cleaned_games.count())
...
plt.plot(gaNNDF['numIters'], gaNNDF['TrainError'], label='GA Training Error')
plt.plot(gaNNDF['numIters'], gaNNDF['TestingError'], label='GA Testing Error')
plt.xlabel('Iterations')
plt.ylabel("Error")
plt.legend(loc="best")
plt.grid()
...
plt.plot(gaNNDF['numIters'], gaNNDF['TrainAccuracy'], label='GA Training Accuracy')
plt.plot(gaNNDF['numIters'], gaNNDF['TestAccuracy'], label='GA Testing Accuracy')
plt.xlabel('Iterations')
plt.ylabel("Accuracy")
plt.legend(loc="best")
plt.grid()
